...
public class GraphV3 {
    ...
    public GraphV3(int w, int h, String title, long[] LinearSearch, long[] BinarySearch, long[] SortedListSearch) {
        maxWidth = w;
        maxHeight = h;
        ...
        Canvas canvas = new Canvas("The graph of " + title + " for binary and linear search algorithms", maxWidth, maxHeight);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawString("The graph of " + title + " for binary and linear search algorithms", 150, 10);
        ...
        for(currentX = 0; currentX < Math.log10(UpperMax); currentX++) {
            ...
            canvas.drawLine(80, (int) (OriginY - currentY - 7), (int) MAXX, (int) (OriginY - currentY - 7));
        ...
        for(updateXPoint = 0; updateXPoint < 10; updateXPoint++) {
            ...
            canvas.drawLine((int)currentX, (int)OriginY, (int)currentX, (int)MAXY);
            currentX = (int)((double)currentX + ScalingFactorX * Math.pow(10.00, 4.00)) + 1;
            currentValue += 10000;
        }
        ...
        for(int i = 0; i < this.linearSearch.length; ++i) {
            canvas.setForegroundColor(Color.BLACK);
            int currentYLinearSearch = (int)(OriginY - Math.log10(linearSearch[i]) * ScalingFactorY);
            canvas.fillCircle((int)(OriginX + ScalingFactorX * updateXPoint) - 10, currentYLinearSearch - 5, 10);

            LinearDataPointsX.add((long) (OriginX + ScalingFactorX * updateXPoint) - 10);
            ...
            canvas.fillCircle((int)(OriginX + ScalingFactorX * updateXPoint) - 10, currentYBinarySearch - 5, 10);

            BinaryDataPointsX.add((long) (OriginX + ScalingFactorX * updateXPoint) - 10);
            ...
            canvas.fillCircle((int)(OriginX + ScalingFactorX * updateXPoint) - 10, sortedLinearSearch - 5, 10);

            SortedLinearDataPointsX.add((long) (OriginX + ScalingFactorX * updateXPoint) - 10);
